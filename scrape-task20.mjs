/**
 * scrape-task20.mjs
 * Парсит задания №20 (вторая часть) с shkolkovo.online через подключение к открытому браузеру.
 *
 * Особенности задания 20:
 * - Задания содержат формулы (img.math) и/или чертежи (div.center)
 * - Ответ в большинстве заданий — SVG-изображение (img.math после "Ответ:")
 * - Ответ сохраняется как SVG-файл: {taskId}_answer.svg
 * - Проверка правильности ответа пользователем визуально (не числовая)
 *
 * Usage: node scrape-task20.mjs
 * Output: подготовка к базе/Задание 20/tasks.json
 *         server/public/formulas/task20/*.svg
 */
...
const SUBTYPES = [
  { name: 'Тип 1',  url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=9331' },
  { name: 'Тип 2',  url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=9333' },
  { name: 'Тип 3',  url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=9335' },
  { name: 'Тип 4',  url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=9337' },
  { name: 'Тип 5',  url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=9339' },
  { name: 'Тип 6',  url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=9341' },
  { name: 'Тип 7',  url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=9343' },
  { name: 'Тип 8',  url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=9345' },
  { name: 'Тип 9',  url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=9347' },
  { name: 'Тип 10', url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=9349' },
  { name: 'Тип 11', url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=9350' },
  { name: 'Тип 12', url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=9353' },
  { name: 'Тип 13', url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=9355' },
  { name: 'Тип 14', url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=9357' },
  { name: 'Тип 15', url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=9359' },
  { name: 'Тип 16', url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=12728' },
  { name: 'Тип 17', url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=12729' },
  { name: 'Тип 18', url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=12730' },
  { name: 'Тип 19', url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=12731' },
  { name: 'Тип 20', url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=12732' },
  { name: 'Тип 21', url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=12733' },
  { name: 'Тип 22', url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=12734' },
  { name: 'Тип 23', url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=13449' },
  { name: 'Тип 24', url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=13450' },
  { name: 'Тип 25', url: 'https://3.shkolkovo.online/catalog/7230?SubTheme=13451' },
];

const OUTPUT_DIR = join(__dirname, 'подготовка к базе', 'Задание 20');
const SVG_DIR = join(__dirname, 'server', 'public', 'formulas', 'task20');
  ...
  for (const task of tasks) {
    ...
    if (task.hasFormulas) {
      ...
      for (const part of task.parts) {
        ...
        const relPath = `formulas/task20/${svgFilename}`;
    ...
    if (task.answerSrc) {
      ...
      const answerRelPath = `formulas/task20/${answerFilename}`;

      try {
        const ok = await downloadSvgViaBrowser(page, task.answerSrc, answerSvgPath);
        if (ok) {
          task.answer = answerRelPath;  // ответ = путь к SVG-файлу
