/**
 * scrape-task11.mjs
 * Парсит задания №11 с shkolkovo.online через подключение к открытому браузеру.
 *
 * Задания содержат формулы (img.math) и чертежи (графики функций).
 * Задания с img.math или чертежом → parts. Без них → plain text.
 *
 * Usage: node scrape-task11.mjs
 * Output: подготовка к базе/Задание 11/tasks.json
 *         server/public/formulas/task11/*.svg
 */
...
const SUBTYPES = [
  { name: 'Тип 1', url: 'https://3.shkolkovo.online/catalog/7150?SubTheme=9513' },
  { name: 'Тип 2', url: 'https://3.shkolkovo.online/catalog/7150?SubTheme=9514' },
  { name: 'Тип 3', url: 'https://3.shkolkovo.online/catalog/7150?SubTheme=9515' },
  { name: 'Тип 4', url: 'https://3.shkolkovo.online/catalog/7150?SubTheme=9516' },
  { name: 'Тип 5', url: 'https://3.shkolkovo.online/catalog/7150?SubTheme=9517' },
  { name: 'Тип 6', url: 'https://3.shkolkovo.online/catalog/7150?SubTheme=9518' },
  { name: 'Тип 7', url: 'https://3.shkolkovo.online/catalog/7150?SubTheme=9519' },
  { name: 'Тип 8', url: 'https://3.shkolkovo.online/catalog/7150?SubTheme=9520' },
  { name: 'Тип 9', url: 'https://3.shkolkovo.online/catalog/7150?SubTheme=9521' },
];

const OUTPUT_DIR = join(__dirname, 'подготовка к базе', 'Задание 11');
const SVG_DIR = join(__dirname, 'server', 'public', 'formulas', 'task11');
  ...
  for (const task of tasks) {
    ...
    if (task.hasFormulas) {
      ...
      for (const part of task.parts) {
        ...
        const relPath = `formulas/task11/${svgFilename}`;
