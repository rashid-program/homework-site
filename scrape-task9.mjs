/**
 * scrape-task9.mjs
 * Парсит задания №9 с shkolkovo.online через подключение к открытому браузеру.
 *
 ...
 *
 * Usage: node scrape-task9.mjs
 * Output: подготовка к базе/Задание 9/tasks.json
 */
...
// 10 типов заданий №9
const SUBTYPES = [
  { name: 'Тип 1', url: 'https://3.shkolkovo.online/catalog/7148?SubTheme=9494' },
  { name: 'Тип 2', url: 'https://3.shkolkovo.online/catalog/7148?SubTheme=9495' },
  { name: 'Тип 3', url: 'https://3.shkolkovo.online/catalog/7148?SubTheme=9496' },
  { name: 'Тип 4', url: 'https://3.shkolkovo.online/catalog/7148?SubTheme=9497' },
  { name: 'Тип 5', url: 'https://3.shkolkovo.online/catalog/7148?SubTheme=9498' },
  { name: 'Тип 6', url: 'https://3.shkolkovo.online/catalog/7148?SubTheme=9499' },
  { name: 'Тип 7', url: 'https://3.shkolkovo.online/catalog/7148?SubTheme=9500' },
  { name: 'Тип 8', url: 'https://3.shkolkovo.online/catalog/7148?SubTheme=9501' },
  { name: 'Тип 9', url: 'https://3.shkolkovo.online/catalog/7148?SubTheme=9502' },
  { name: 'Тип 10', url: 'https://3.shkolkovo.online/catalog/7148?SubTheme=9503' },
];

const OUTPUT_DIR = join(__dirname, 'подготовка к базе', 'Задание 9');
