/**
 * scrape-task21.mjs
 * Парсит задания №21 (текстовые задачи на движение/работу) с shkolkovo.online через CDP.
 *
 * Особенности задания 21:
 * - Задания чисто текстовые (нет img.math, нет чертежей)
 * - Ответ текстовый
 * - 20 типов (подтем)
 *
 * Usage: node scrape-task21.mjs
 * Output: подготовка к базе/Задание 21/tasks.json
 */
...
const SUBTYPES = [
  { name: 'Тип 1',  url: 'https://3.shkolkovo.online/catalog/7160?SubTheme=9332' },
  { name: 'Тип 2',  url: 'https://3.shkolkovo.online/catalog/7160?SubTheme=9334' },
  { name: 'Тип 3',  url: 'https://3.shkolkovo.online/catalog/7160?SubTheme=9336' },
  { name: 'Тип 4',  url: 'https://3.shkolkovo.online/catalog/7160?SubTheme=9338' },
  { name: 'Тип 5',  url: 'https://3.shkolkovo.online/catalog/7160?SubTheme=9340' },
  { name: 'Тип 6',  url: 'https://3.shkolkovo.online/catalog/7160?SubTheme=9342' },
  { name: 'Тип 7',  url: 'https://3.shkolkovo.online/catalog/7160?SubTheme=9344' },
  { name: 'Тип 8',  url: 'https://3.shkolkovo.online/catalog/7160?SubTheme=9346' },
  { name: 'Тип 9',  url: 'https://3.shkolkovo.online/catalog/7160?SubTheme=9348' },
  { name: 'Тип 10', url: 'https://3.shkolkovo.online/catalog/7160?SubTheme=9351' },
  { name: 'Тип 11', url: 'https://3.shkolkovo.online/catalog/7160?SubTheme=9352' },
  { name: 'Тип 12', url: 'https://3.shkolkovo.online/catalog/7160?SubTheme=9354' },
  { name: 'Тип 13', url: 'https://3.shkolkovo.online/catalog/7160?SubTheme=9356' },
  { name: 'Тип 14', url: 'https://3.shkolkovo.online/catalog/7160?SubTheme=9358' },
  { name: 'Тип 15', url: 'https://3.shkolkovo.online/catalog/7160?SubTheme=9360' },
  { name: 'Тип 16', url: 'https://3.shkolkovo.online/catalog/7160?SubTheme=9362' },
  { name: 'Тип 17', url: 'https://3.shkolkovo.online/catalog/7160?SubTheme=9364' },
  { name: 'Тип 18', url: 'https://3.shkolkovo.online/catalog/7160?SubTheme=9366' },
  { name: 'Тип 19', url: 'https://3.shkolkovo.online/catalog/7160?SubTheme=9368' },
  { name: 'Тип 20', url: 'https://3.shkolkovo.online/catalog/7160?SubTheme=9370' },
];

const OUTPUT_DIR = join(__dirname, 'подготовка к базе', 'Задание 21');
const SVG_DIR = join(__dirname, 'server', 'public', 'formulas', 'task21');
...
for (const subtype of SUBTYPES) {
  ...
  // Задание 21 — чисто текстовые, SVG формул нет
  // Но на случай если вдруг попадутся формулы — обрабатываем корректно
  for (const task of tasks) {
    task.svgFiles = [];

    if (task.hasFormulas) {
      // Скачиваем SVG формул
      ...
      for (const part of task.parts) {
        ...
        const relPath = `formulas/task21/${svgFilename}`;
    ...
    // Чисто текстовое: убираем parts если нет формул, используем text-строку
    if (!task.hasFormulas) {
      // Собираем весь текст в единую строку для поля text
