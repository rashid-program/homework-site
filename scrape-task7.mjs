/**
 * scrape-task7.mjs
 * Парсит задания №7 с shkolkovo.online через подключение к открытому браузеру.
 *
 * Задания содержат 1–3 img.math и часто чертёж (числовая прямая).
 * Задания с img.math или чертежом → parts. Без них → plain text.
 *
 * Usage: node scrape-task7.mjs
 * Output: подготовка к базе/Задание 7/tasks.json
 *         server/public/formulas/task7/*.svg
 */
...
const SUBTYPES = [
  { name: 'Тип 1',  url: 'https://3.shkolkovo.online/catalog/7146?SubTheme=10541' },
  { name: 'Тип 2',  url: 'https://3.shkolkovo.online/catalog/7146?SubTheme=10542' },
  { name: 'Тип 3',  url: 'https://3.shkolkovo.online/catalog/7146?SubTheme=10543' },
  { name: 'Тип 4',  url: 'https://3.shkolkovo.online/catalog/7146?SubTheme=10544' },
  { name: 'Тип 5',  url: 'https://3.shkolkovo.online/catalog/7146?SubTheme=10545' },
  { name: 'Тип 6',  url: 'https://3.shkolkovo.online/catalog/7146?SubTheme=10546' },
  { name: 'Тип 7',  url: 'https://3.shkolkovo.online/catalog/7146?SubTheme=10547' },
  { name: 'Тип 8',  url: 'https://3.shkolkovo.online/catalog/7146?SubTheme=10548' },
  { name: 'Тип 9',  url: 'https://3.shkolkovo.online/catalog/7146?SubTheme=10549' },
  { name: 'Тип 10', url: 'https://3.shkolkovo.online/catalog/7146?SubTheme=10550' },
  { name: 'Тип 11', url: 'https://3.shkolkovo.online/catalog/7146?SubTheme=10551' },
  { name: 'Тип 12', url: 'https://3.shkolkovo.online/catalog/7146?SubTheme=10552' },
  { name: 'Тип 13', url: 'https://3.shkolkovo.online/catalog/7146?SubTheme=10553' },
  { name: 'Тип 14', url: 'https://3.shkolkovo.online/catalog/7146?SubTheme=10554' },
  { name: 'Тип 15', url: 'https://3.shkolkovo.online/catalog/7146?SubTheme=10555' },
];

const OUTPUT_DIR = join(__dirname, 'подготовка к базе', 'Задание 7');
const SVG_DIR = join(__dirname, 'server', 'public', 'formulas', 'task7');
...
for (const subtype of SUBTYPES) {
  ...
  const tasks = await page.evaluate((subtypeName) => {
    ...
    for (const ex of exercises) {
      ...
      // parts — массив { type: 'text'|'img'|'drawing', value?: string, src?: string }
      const parts = [];
      const formulaSrcs = [];
  ...
  for (const task of tasks) {
    ...
    if (task.hasFormulas) {
      ...
      for (const part of task.parts) {
        ...
        const relPath = `formulas/task7/${svgFilename}`;
