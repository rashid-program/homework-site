/**
 * scrape-task10.mjs
 * Парсит задания №10 с shkolkovo.online через подключение к открытому браузеру.
 *
 ...
 *
 * Usage: node scrape-task10.mjs
 * Output: подготовка к базе/Задание 10/tasks.json
 */
...
// 8 типов заданий №10
const SUBTYPES = [
  { name: 'Тип 1', url: 'https://3.shkolkovo.online/catalog/7149?SubTheme=9504' },
  { name: 'Тип 2', url: 'https://3.shkolkovo.online/catalog/7149?SubTheme=9505' },
  { name: 'Тип 3', url: 'https://3.shkolkovo.online/catalog/7149?SubTheme=9506' },
  { name: 'Тип 4', url: 'https://3.shkolkovo.online/catalog/7149?SubTheme=9507' },
  { name: 'Тип 5', url: 'https://3.shkolkovo.online/catalog/7149?SubTheme=9508' },
  { name: 'Тип 6', url: 'https://3.shkolkovo.online/catalog/7149?SubTheme=9509' },
  { name: 'Тип 7', url: 'https://3.shkolkovo.online/catalog/7149?SubTheme=9510' },
  { name: 'Тип 8', url: 'https://3.shkolkovo.online/catalog/7149?SubTheme=9512' },
];

const OUTPUT_DIR = join(__dirname, 'подготовка к базе', 'Задание 10');
