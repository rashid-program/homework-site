/**
 * scrape-task16.mjs
 * Парсит задания №16 с shkolkovo.online через подключение к открытому браузеру.
 *
 * Задания содержат текст с 0–8 img.math (буквы точек, углы) + чертёж в div.center.
 * Задания с img.math или чертежом → parts. Без картинок → plain text.
 *
 * Usage: node scrape-task16.mjs
 * Output: подготовка к базе/Задание 16/tasks.json
 *         server/public/formulas/task16/*.svg
 */
...
const SUBTYPES = [
  { name: 'Тип 1',  url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9587' },
  { name: 'Тип 2',  url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9588' },
  { name: 'Тип 3',  url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9589' },
  { name: 'Тип 4',  url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9590' },
  { name: 'Тип 5',  url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9591' },
  { name: 'Тип 6',  url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9592' },
  { name: 'Тип 7',  url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9593' },
  { name: 'Тип 8',  url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9594' },
  { name: 'Тип 9',  url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9595' },
  { name: 'Тип 10', url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9596' },
  { name: 'Тип 11', url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9597' },
  { name: 'Тип 12', url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9598' },
  { name: 'Тип 13', url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9599' },
  { name: 'Тип 14', url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9600' },
  { name: 'Тип 15', url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9601' },
  { name: 'Тип 16', url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9602' },
  { name: 'Тип 17', url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9603' },
  { name: 'Тип 18', url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9604' },
  { name: 'Тип 19', url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9605' },
  { name: 'Тип 20', url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9606' },
  { name: 'Тип 21', url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9607' },
  { name: 'Тип 22', url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9608' },
  { name: 'Тип 23', url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9609' },
  { name: 'Тип 24', url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9610' },
  { name: 'Тип 25', url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9611' },
  { name: 'Тип 26', url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9612' },
  { name: 'Тип 27', url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9613' },
  { name: 'Тип 28', url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9614' },
  { name: 'Тип 29', url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9615' },
  { name: 'Тип 30', url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9616' },
  { name: 'Тип 31', url: 'https://3.shkolkovo.online/catalog/7116?SubTheme=9617' },
];

const OUTPUT_DIR = join(__dirname, 'подготовка к базе', 'Задание 16');
const SVG_DIR = join(__dirname, 'server', 'public', 'formulas', 'task16');
...
for (const subtype of SUBTYPES) {
  ...
  const tasks = await page.evaluate((subtypeName) => {
    ...
    for (const ex of exercises) {
      ...
      if (textContainer) {
        // Ищем TexRender-контейнер или используем textContainer напрямую
  ...
  for (const task of tasks) {
    ...
    if (task.hasFormulas) {
      ...
      for (const part of task.parts) {
        ...
        const relPath = `formulas/task16/${svgFilename}`;
