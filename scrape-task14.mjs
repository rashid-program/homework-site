/**
 * scrape-task14.mjs
 * Парсит задания №14 с shkolkovo.online через подключение к открытому браузеру.
 *
 ...
 *
 * Usage: node scrape-task14.mjs
 * Output: подготовка к базе/Задание 14/tasks.json
 */
...
// 11 типов заданий №14
const SUBTYPES = [
  { name: 'Тип 1',  url: 'https://3.shkolkovo.online/catalog/7153?SubTheme=9546' },
  { name: 'Тип 2',  url: 'https://3.shkolkovo.online/catalog/7153?SubTheme=9547' },
  { name: 'Тип 3',  url: 'https://3.shkolkovo.online/catalog/7153?SubTheme=9548' },
  { name: 'Тип 4',  url: 'https://3.shkolkovo.online/catalog/7153?SubTheme=9549' },
  { name: 'Тип 5',  url: 'https://3.shkolkovo.online/catalog/7153?SubTheme=9550' },
  { name: 'Тип 6',  url: 'https://3.shkolkovo.online/catalog/7153?SubTheme=9551' },
  { name: 'Тип 7',  url: 'https://3.shkolkovo.online/catalog/7153?SubTheme=9552' },
  { name: 'Тип 8',  url: 'https://3.shkolkovo.online/catalog/7153?SubTheme=9553' },
  { name: 'Тип 9',  url: 'https://3.shkolkovo.online/catalog/7153?SubTheme=9554' },
  { name: 'Тип 10', url: 'https://3.shkolkovo.online/catalog/7153?SubTheme=9555' },
  { name: 'Тип 11', url: 'https://3.shkolkovo.online/catalog/7153?SubTheme=9556' },
];

const OUTPUT_DIR = join(__dirname, 'подготовка к базе', 'Задание 14');
