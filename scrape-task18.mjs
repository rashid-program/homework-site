/**
 * scrape-task18.mjs
 * Парсит задания №18 с shkolkovo.online через подключение к открытому браузеру.
 *
 * Задания содержат формулы (img.math) и чертежи (рисунки на клетчатой бумаге).
 * Структура: 1 <p> с формулами + 1 div.center с чертежом.
 *
 * Usage: node scrape-task18.mjs
 * Output: подготовка к базе/Задание 18/tasks.json
 *         server/public/formulas/task18/*.svg
 */
...
const SUBTYPES = [
  { name: 'Тип 1',  url: 'https://3.shkolkovo.online/catalog/7157?SubTheme=9648' },
  { name: 'Тип 2',  url: 'https://3.shkolkovo.online/catalog/7157?SubTheme=9649' },
  { name: 'Тип 3',  url: 'https://3.shkolkovo.online/catalog/7157?SubTheme=9650' },
  { name: 'Тип 4',  url: 'https://3.shkolkovo.online/catalog/7157?SubTheme=9651' },
  { name: 'Тип 5',  url: 'https://3.shkolkovo.online/catalog/7157?SubTheme=9652' },
  { name: 'Тип 6',  url: 'https://3.shkolkovo.online/catalog/7157?SubTheme=9653' },
  { name: 'Тип 7',  url: 'https://3.shkolkovo.online/catalog/7157?SubTheme=9654' },
  { name: 'Тип 8',  url: 'https://3.shkolkovo.online/catalog/7157?SubTheme=9655' },
  { name: 'Тип 9',  url: 'https://3.shkolkovo.online/catalog/7157?SubTheme=9656' },
  { name: 'Тип 10', url: 'https://3.shkolkovo.online/catalog/7157?SubTheme=9657' },
  { name: 'Тип 11', url: 'https://3.shkolkovo.online/catalog/7157?SubTheme=9658' },
  { name: 'Тип 12', url: 'https://3.shkolkovo.online/catalog/7157?SubTheme=9659' },
  { name: 'Тип 13', url: 'https://3.shkolkovo.online/catalog/7157?SubTheme=9660' },
  { name: 'Тип 14', url: 'https://3.shkolkovo.online/catalog/7157?SubTheme=9661' },
  { name: 'Тип 15', url: 'https://3.shkolkovo.online/catalog/7157?SubTheme=9662' },
];

const OUTPUT_DIR = join(__dirname, 'подготовка к базе', 'Задание 18');
const SVG_DIR = join(__dirname, 'server', 'public', 'formulas', 'task18');
  ...
  for (const task of tasks) {
    ...
    if (task.hasFormulas) {
      ...
      for (const part of task.parts) {
        ...
        const relPath = `formulas/task18/${svgFilename}`;
